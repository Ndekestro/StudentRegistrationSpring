...
import com.auca.StudentRegistration.StRegistrationService.CourseService;
...
public class CourseController {
    ...
    @PostMapping(value = "/savetheCourse")
    public ResponseEntity<?> createCourse(@RequestBody Course course){
        if(course != null ){String message = courseService.saveCourse(course);
            if(message != null){
    ...
    @GetMapping(value = "/listofCourse")
    public ResponseEntity<List<Course>> listCourses() {
        List<Course> courses = courseService.listCourses();
        return new ResponseEntity<>(courses, HttpStatus.OK);
    }

    @PutMapping(value = "/updatetheCourse/{code}")
    ...
    //delete
    @DeleteMapping(value = "/deletetheCourse/{id}")
    public ResponseEntity<String> deleteCourse(@PathVariable Integer id) {
        if (id != null) {String message = courseService.deleteCourse(id);
            if (message != null) {
