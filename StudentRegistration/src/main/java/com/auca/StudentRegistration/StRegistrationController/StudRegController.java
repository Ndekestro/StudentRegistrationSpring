...
import com.auca.StudentRegistration.StRegistrationService.StudRegistrationService;
...
public class StudRegController {
    ...
    @PostMapping(value = "/savetheRegistration")
    ...
    @GetMapping(value = "/listtheRegistrations")
    ...
    @PutMapping(value = "/updatetheRegistration/{id}")
    ...
    @DeleteMapping(value = "/deletetheRegistration/{id}")
