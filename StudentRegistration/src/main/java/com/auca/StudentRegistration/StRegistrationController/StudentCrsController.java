...
import com.auca.StudentRegistration.StRegistrationService.*;
...
public class StudentCrsController {
    ...
    @PostMapping(value = "/savetheStudCourse")
    ...
    @GetMapping(value = "/listtheStudCourse")
    ...
    @PutMapping(value = "/updatetheStudCourse/{id}")
    ...
    @DeleteMapping(value = "/deletetheStudCourse/{id}")
